...
export const SERVICE_DETAIL_PAGES: Record<ServiceDetailSlug, ServiceDetailPage> = {
  'air-freight': {
    ...
    metaDescription:
      'Fast and secure air freight services with global delivery, express cargo handling, and airport-to-airport logistics support.',
    paragraphs: [
  ...
  'sea-freight': {
    ...
    metaDescription:
      'Cost-effective sea freight solutions including FCL, LCL, port-to-port delivery, and international ocean cargo management.',
    paragraphs: [
  ...
  'land-transport': {
    ...
    metaDescription:
      'Secure land transport and road freight services with door-to-door delivery, regional haulage, and cargo distribution support.',
    paragraphs: [
  ...
  warehousing: {
    ...
    metaDescription:
      'Strategic warehousing and inventory management solutions for efficient cargo storage, fulfillment, and distribution operations.',
    paragraphs: [
  ...
  'freight-forwarding': {
    ...
    heroImage: '/landing/sea-freight.png',
    metaDescription:
      'Reliable freight forwarding with customs clearance, multimodal transport, shipment coordination, and global logistics support.',
    paragraphs: [
  ...
  'transportation-management': {
    ...
    heroImage: '/landing/land-transport.png',
    metaDescription:
      'Transportation management solutions with route optimization, carrier planning, shipment tracking, and logistics cost control.',
    paragraphs: [
  ...
  'supply-chain': {
    ...
    metaDescription:
      'End-to-end supply chain solutions including procurement, inventory, warehousing, and distribution for global businesses.',
    paragraphs: [
  ...
  'last-mile-delivery': {
    ...
    heroImage: '/landing/land-transport.png',
    metaDescription:
      'Reliable last mile delivery with dispatch optimization, real-time tracking, and seamless final-mile logistics operations.',
    paragraphs: [
  ...
  'ecommerce-logistics': {
    ...
    heroImage: '/landing/warehousing-distribution.png',
    metaDescription:
      'Ecommerce logistics solutions including order fulfillment, inventory management, warehousing, and fast delivery services.',
    paragraphs: [
  ...
  'reverse-logistics': {
    ...
    metaDescription:
      'Reverse logistics solutions for returns, product recovery, refurbishment, recycling, and supply chain efficiency improvement.',
    paragraphs: [
  ...
  'heavy-goods-handling': {
    ...
    heroImage: '/landing/sea-freight.png',
    metaDescription:
      'Specialized heavy goods handling for oversized cargo, industrial transport, project logistics, and safe global delivery.',
    paragraphs: [
